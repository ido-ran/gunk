package ee.gunk
{
	...
	{		
		...
		[Test]
		public function testSignature_hashTypeEqual():void
		{
			var s1:Key = new Key(TestType1);
		...
		[Test]
		public function testSignature_hashTypeNotEqual():void
		{
			var s1:Key = new Key(TestType1);
		...
		[Test]
		public function testSignature_hashAnnotationsEqual():void
		{
		...
		[Test]
		public function testSignature_hashAnnotationsNotEqual():void
		{
			var a1:Vector.<IAnnotation> = new Vector.<IAnnotation>();
			a1.push(new Type("ee.di.testClasses.injectables.types.TestType1"));
		...
		[Test]
		public function testSignature_fullHashTypeEqual():void
		{
		...
		[Test]
		public function testSignature_fullHashTypeNotEqual():void
		{
			var d1:Key = new Key(TestType1);	
		...
		[Test]
		public function testSignature_fullHashAnnotationsEqual():void
		{
			var a1:Vector.<IAnnotation> = new Vector.<IAnnotation>();
			a1.push(new Type("ee.di.testClasses.injectables.types.TestType1"));
		...
		[Test]
		public function testSignature_fullHashAnnotationsNotEqual():void
		{
			var a1:Vector.<IAnnotation> = new Vector.<IAnnotation>();
			a1.push(new Type("ee.di.testClasses.injectables.types.TestType1"));
